...
public interface CommentService {
    HashMap<String,Object> saveComment(Map<String, Object> requestBody, String email); 
    HashMap<String,Object> deleteComment(Map<String, Object> requestBody, String email);
	HashMap<String, Object> updateComment(Map<String, Object> requestBody, String email);
