package taskline.product.appointment;
...
import taskline.appointment.AppointmentResourceFactory;
import taskline.appointment.core.AppointmentResource;
import taskline.appointment.InvitedUserResourceFactory;
import taskline.appointment.core.InvitedUserResource;
import taskline.appointment.AppointmentServiceFactory;
import taskline.appointment.core.AppointmentService;
import taskline.appointment.InvitedUserServiceFactory;
import taskline.appointment.core.InvitedUserService;
...
public class Appointment {
	...
	public static void main(String[] args) {
		...
		configuration.addAnnotatedClass(taskline.appointment.core.Appointment.class);
		configuration.addAnnotatedClass(taskline.appointment.core.AppointmentComponent.class);
		configuration.addAnnotatedClass(taskline.appointment.core.AppointmentDecorator.class);
		configuration.addAnnotatedClass(taskline.appointment.core.AppointmentImpl.class);
		configuration.addAnnotatedClass(taskline.appointment.core.InvitedUser.class);
		configuration.addAnnotatedClass(taskline.appointment.core.InvitedUserComponent.class);
		configuration.addAnnotatedClass(taskline.appointment.core.InvitedUserDecorator.class);
		configuration.addAnnotatedClass(taskline.appointment.core.InvitedUserImpl.class);
	...
	public static void createObjectsAndBindEndPoints() {
        ...
        AppointmentService appointmentAppointment2Service = AppointmentServiceFactory
            .createAppointmentService("taskline.appointment.core.AppointmentServiceImpl"
            	);		
        InvitedUserService appointmentInvitedUser2Service = InvitedUserServiceFactory
            .createInvitedUserService("taskline.appointment.core.InvitedUserServiceImpl"
            	);		

        AppointmentResource appointmentAppointment2Resource = AppointmentResourceFactory
            .createAppointmentResource("taskline.appointment.core.AppointmentResourceImpl"
                );
        InvitedUserResource appointmentInvitedUser2Resource = InvitedUserResourceFactory
            .createInvitedUserResource("taskline.appointment.core.InvitedUserResourceImpl"
                );
			

		System.out.println("appointmentAppointment2Resource endpoints binding");
		Router.route(appointmentAppointment2Resource);
		
		System.out.println("appointmentInvitedUser2Resource endpoints binding");
		Router.route(appointmentInvitedUser2Resource);
		
		System.out.println("appointmentAppointment2Service endpoints binding");
		Router.route(appointmentAppointment2Service);
		
		System.out.println("appointmentInvitedUser2Service endpoints binding");
		Router.route(appointmentInvitedUser2Service);
	...
	private static Map<String, Object> mappingFeatureModel() {
		...
		featureModelMappings.put(
            taskline.appointment.core.InvitedUserComponent.class.getName(),
			new HashMap<String, String[]>() {{
				put("components", new String[] {
					taskline.appointment.core.AppointmentComponent.class.getName(),
					taskline.appointment.core.InvitedUserComponent.class.getName()
				});
				put("deltas", new String[] {
				});
